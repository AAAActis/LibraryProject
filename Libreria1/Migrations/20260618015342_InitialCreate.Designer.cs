...
namespace Libreria1.Migrations
{
    ...
    [Migration("20260618015342_InitialCreate")]
            ...
            modelBuilder.Entity("Libreria1.Domain.Entities.Multa", b =>
                {
                    ...
                    b.Property<Guid>("PrestamoAsignadoId")
                        .HasColumnType("uuid");

                    b.HasKey("Id");

                    b.HasIndex("PrestamoAsignadoId");
            ...
            modelBuilder.Entity("Libreria1.Domain.Entities.Prestamo", b =>
                {
                    ...
                    b.Property<string>("LibroPrestadoIsbn")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Libreria1.Domain.Entities.Multa", b =>
                {
                    b.HasOne("Libreria1.Domain.Entities.Prestamo", "PrestamoAsignado")
                        .WithMany()
                        .HasForeignKey("PrestamoAsignadoId")
            ...
            modelBuilder.Entity("Libreria1.Domain.Entities.Prestamo", b =>
                {
                    b.HasOne("Libreria1.Domain.Entities.Libro", "LibroPrestado")
                        .WithMany()
                        .HasForeignKey("LibroPrestadoIsbn");
